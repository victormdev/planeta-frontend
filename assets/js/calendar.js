// generate events
var eventDates = {}
let day1 = formatDate(new Date(new Date().setDate(new Date().getMonth() + 1)))
eventDates[day1] = [
  'Seersuckers & Sundresses, World Equestrian Center, 3p-7p'
]
let day2 = formatDate(new Date(new Date().setDate(new Date().getDate() + 37)))
eventDates[day2] = [
  'Kids Holiday Party, Liberty Park',
]
